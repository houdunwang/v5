...
<script type='text/javascript'>
		...
		URL = 'http://localhost/v5/cms/index.php/Article/Article/add';
		...
		METH = 'http://localhost/v5/cms/index.php/Article/Article/add';
			 ...
			 <div id="ext">
				<table class='table1'>
					<tr>
						...
						<td><input type='text' name='keywords' class='w300'/></td>
					</tr>
					<tr>
						<th>描述</th>
						<td>
							<textarea class='w400 h100' name='description'></textarea>
						</td>
					</tr>
					<tr>
						<th class='w100'>点击数</th>
						<td><input type='text' name='click' class='w300' value='100'/></td>
					</tr>
					<tr>
						<th class='w100'>来源</th>
					...
					<tr>
						<th class='w100'>作者</th>
						<td><input type='text' name='author' class='w300' value='<?php echo $_SESSION['username'];?>'/></td>
					</tr>
					<tr>
