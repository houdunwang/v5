...
<script type='text/javascript'>
		...
		URL = 'http://localhost/v5/plugin/index.php?g=Plugin&a=Link&c=Manage&m=index&_=0.6400806615129113';
		...
		METH = 'http://localhost/v5/plugin/index.php?a=Link&c=Manage&m=index';
...
<div class="wrap">
    <div class="menu_list">
        <ul>
            <li><a href="http://localhost/v5/plugin/index.php?g=Plugin&a=Link&c=Manage&m=index" class="action">友情链接</a></li>
...
if($_index_l>=$_total_l):$hd["list"]["l"]["last"]=true;endif;?>
            ...
            <tr>
                ...
                <td><?php echo $l['type_name'];?>(<?php echo $l['tid'];?>)</td>
                <td>
