<?php if(!defined("HDPHP_PATH"))exit;C("SHOW_NOTICE",FALSE);?><link rel="stylesheet" type="text/css" href="http://localhost/v5/plugin/hd/Hdcms/Index/Tpl/Comment/css/comment.css?ver=1.0"/>
<script type="text/javascript" src="http://localhost/v5/plugin/hd/Hdcms/Index/Tpl/Comment/js/comment.js"></script>
<script>
 	var WEB='http://localhost/v5/plugin/index.php';
    $(function(){
    	//跳转到指定的评论
...
<div class="hd-comment">
    <!--评论标题-->
    <div class="title">
        <img src="<?php echo _default($_SESSION['icon'],'http://localhost/v5/plugin/data/image/user/50-gray.png');?>"/> 发表我的评论
    </div>
    <!--发表评论-->
    <div class="publish">
...
if($_index_a>=$_total_a):$hd["list"]["a"]["last"]=true;endif;?>
                ...
                <li id="c<?php echo $a['comment_id'];?>">
                    <div class="hd-comment-face">
                        <a href="http://localhost/v5/plugin/index.php?<?php echo $a['domain'];?>">
                    ...
                    <div class="hd-comment-content">
                        ...
                        <div class="hd-author-info">
                            <span class="hd-comment-author">
                                <a href="http://localhost/v5/plugin/index.php?<?php echo $a['domain'];?>"><?php echo $a['nickname'];?></a>&nbsp;&nbsp;
                            </span>
...
if($_index_b>=$_total_b):$hd["list"]["b"]["last"]=true;endif;?>
                            ...
                            <li id="c<?php echo $b['comment_id'];?>">
                                <div class="hd-comment-face">
                                    <a href="http://localhost/v5/plugin/index.php?<?php echo $b['domain'];?>">
                                ...
                                <div class="hd-comment-content">
                                    ...
                                    <div class="hd-author-info">
                            <span class="hd-comment-author">
                                <a href="http://localhost/v5/plugin/index.php?<?php echo $b['domain'];?>"><?php echo $b['nickname'];?></a>&nbsp;&nbsp;
                            </span>
...
if($_index_c>=$_total_c):$hd["list"]["c"]["last"]=true;endif;?>
                                        ...
                                        <li class="bg-white" id="c<?php echo $c['comment_id'];?>">
                                            <div class="hd-comment-face">
                                                <a href="http://localhost/v5/plugin/index.php?<?php echo $c['domain'];?>">
                                            ...
                                            <div class="hd-comment-content">
                                                ...
                                                <div class="hd-author-info">
                                                <span class="hd-comment-author">
                                                    <a href="http://localhost/v5/plugin/index.php?<?php echo $c['domain'];?>"><?php echo $c['nickname'];?></a>&nbsp;&nbsp;
                                                </span>
...
if($_index_d>=$_total_d):$hd["list"]["d"]["last"]=true;endif;?>
                                                    ...
                                                    <li id="c<?php echo $d['comment_id'];?>">
                                                        <div class="hd-comment-face">
                                                            <a href="http://localhost/v5/plugin/index.php?<?php echo $d['domain'];?>">
                                                        ...
                                                        <div class="hd-comment-content">
                                                            ...
                                                            <div class="hd-author-info">
                                                            <span class="hd-comment-author">
                                                                <a href="http://localhost/v5/plugin/index.php?<?php echo $d['domain'];?>"><?php echo $d['nickname'];?></a>&nbsp;&nbsp;
                                                            </span>
