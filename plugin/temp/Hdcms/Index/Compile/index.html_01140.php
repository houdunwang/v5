...
<script src='http://localhost/v5/plugin/hd/HDPHP/hdphp/Extend/Org/bootstrap/js/bootstrap.min.js'></script>
                ...
                <![endif]-->
		<link rel="stylesheet"  type='text/css' href="http://localhost/v5/plugin/template/default/css/index.css"/>
		<!--[if lt IE 8]>
			...
			<nav class=".navbar-fixed-top" role="navigation">
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						<li class="active">
							<a href="http://localhost/v5/plugin">
								首页
							</a>
						</li>
						        <?php
			...
			<div class="row">
				<div class="col-md-8">
					...
					<article class="top">
						...
						<ul>
							        <?php $mid='';$cid ='';$flag='2,4';$noflag='';$aid='';$type='rand';$sub_channel=1;
            $mid = $mid?$mid:Q('get.mid',1,'intval');
            $cid = $cid?$cid:Q('cid',null,'intval');
            //导入模型类
            $db =ContentViewModel::getInstance($mid);
            ...
            ?>
							<article>
								...
								<div class="author">
									...
									发表于 <?php echo $field['date_before'];?> -
					...
					<article class="soft">
						...
						<div>
							<a href="https://git.oschina.net/houdunwang/hdphp/repository/archive?ref=master">
								HDPHP框架 <span>版本: 2014-05-08</span>
							</a>
							<a href="https://git.oschina.net/houdunwang/hdcms/repository/archive?ref=master" class="hdcms" target="_blank">
								HDCMS系统<span>版本: 2014-05-08</span>
							</a>
						</div>
						<div class="notice">
