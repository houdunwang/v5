...
<script type='text/javascript'>
		...
		URL = 'http://localhost/v5/plugin/index.php?a=Admin&c=Content&m=add&cid=2&mid=1';
		...
		METH = 'http://localhost/v5/plugin/index.php?a=Admin&c=Content&m=add';
		...
		HISTORY = 'http://localhost/v5/plugin/index.php?a=Admin&c=Content&m=content&cid=2&mid=1';
		HTTPREFERER = 'http://localhost/v5/plugin/index.php?a=Admin&c=Content&m=content&cid=2&mid=1';
</script>
    <script type="text/javascript" src="http://localhost/v5/plugin/hd/Hdcms/Admin/Tpl/Content/js/addEdit.js"></script>
