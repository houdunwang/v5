...
<script type='text/javascript'>
		...
		URL = 'http://localhost/v5/plugin/index.php?g=Hdcms&a=Admin&c=Content&m=index&_=0.5077586639672518';
		...
		METH = 'http://localhost/v5/plugin/index.php?a=Admin&c=Content&m=index';
    ...
    <link rel="stylesheet" href="http://localhost/v5/plugin/hd/Hdcms/Admin/Tpl/Content/ztree/css/zTreeStyle/zTreeStyle.css" type="text/css">
    <script type="text/javascript" src="http://localhost/v5/plugin/hd/Hdcms/Admin/Tpl/Content/ztree/js/jquery.ztree.all-3.5.min.js"></script>
    <base target="content"/>
    <style type="text/css">
    div#tree_title a{
    	color:#333;
...
div#move span.left{
    background: url("http://localhost/v5/plugin/hd/Hdcms/Admin/Tpl/Content/img/ico_left.gif") no-repeat;
    left: -10px;
}
div#move span.right{
    background: url("http://localhost/v5/plugin/hd/Hdcms/Admin/Tpl/Content/img/ico_right.gif") no-repeat;
    left: 5px;
}
/*右侧内容显示区*/
div#content {
...
#tree_title span {
    display: block;
    background: url("http://localhost/v5/plugin/hd/Hdcms/Admin/Tpl/Content/ztree/css/zTreeStyle/img/diy/1_open.png");
    width: 15px;
    height: 15px;
    float: left;
    margin-right: 5px;
...
<div class="wrap">
    ...
    <div id="content">
        <iframe src="<?php echo U('welcome');?>" name="content" scrolling="auto" frameborder="0" style="height:100%;width: 100%;"></iframe>
    </div>
</div>
