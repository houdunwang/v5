<?php if(!defined("HDPHP_PATH"))exit;C("SHOW_NOTICE",FALSE);?><div class="hd_user_alert">
    <div class="hd_user_icon">
        <div class="ico_img">
            <a href="http://localhost/v5/cmsweb/hdcms/index.php?<?php echo $field['domain'];?>"><img src="http://localhost/v5/cmsweb/hdcms/<?php echo _default($field['icon'],'data/image/user/100.png');?>"/></a>
        </div>
    </div>
    ...
    <div class="send_message">
        ...
        <?php endif;?>
        <a href="http://localhost/v5/cmsweb/hdcms/index.php?<?php echo $field['domain'];?>">访问主页</a>
        <?php if(isset($_SESSION['uid']) && $_SESSION['uid']!=$field['uid']):?>
