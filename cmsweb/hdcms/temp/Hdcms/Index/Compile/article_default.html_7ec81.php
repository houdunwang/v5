...
<div class="top-message container">
    <span>最新消息：</span>
            <?php $mid='';$cid ='5';$subtable ='';$order ='';$flag='';$noflag='';$aid='';$type='new';$sub_channel=1;
...
<div class="col-md-8">
    ...
    <div id="main">
        ...
        <div class="title">
            ...
            <p>
                <div class="icon">
                <a href="http://localhost/v5/cmsweb/hdcms/index.php?<?php echo $hdcms['domain'];?>">
                ...
                <?php echo $hdcms['comment_num'];?>
                	条评论
                 <script type="text/javascript" src="http://localhost/v5/cmsweb/hdcms/index.php?a=Index&c=Index&m=getClick&mid=<?php echo $hdcms['mid'];?>&cid=<?php echo $hdcms['cid'];?>&aid=<?php echo $hdcms['aid'];?>"></script>次点击
                	所属分类：<a href="<?php echo $hdcms['caturl'];?>"><?php echo $hdcms['catname'];?></a>
                <a href="javascript:content.addFavorite(<?php echo $hdcms['mid'];?>,<?php echo $hdcms['cid'];?>,<?php echo $hdcms['aid'];?>)">加入收藏</a>
            </p>
        </div>
        <div class="content">
    ...
    <!--发表评论-->
    <script type="text/javascript" id="comment" src="http://localhost/v5/cmsweb/hdcms/index.php?a=Index&c=Comment&m=show&mid=<?php echo $hdcms['mid'];?>&cid=<?php echo $hdcms['cid'];?>&aid=<?php echo $hdcms['aid'];?>&comment_id=<?php echo $_GET['comment_id'];?>"></script>
</div>
<!--右侧列表-->
<div class="right-list col-md-4">
   <a href="http://localhost/v5/cmsweb/hdcms/index.php?a=Member&c=Content&m=add&mid=<?php echo $hdcms['mid'];?>&cid=<?php echo $hdcms['cid'];?>" class="publish" target="_blank">
                <strong>+</strong>发表文章
            </a>
    <!--讨论区-->
