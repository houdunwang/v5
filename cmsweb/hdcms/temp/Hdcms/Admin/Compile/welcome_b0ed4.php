...
<script type='text/javascript'>
		...
		URL = 'http://localhost/v5/cmsweb/hdcms/a=Admin&c=Index&m=welcome';
		...
		METH = 'http://localhost/v5/cmsweb/hdcms/index.php?a=Admin&c=Index&m=welcome';
		...
		<link type="text/css" rel="stylesheet" href="http://localhost/v5/cmsweb/hdcms/hd/Hdcms/Admin/Tpl/Index/css/welcome.css"/>
	</head>
	<body>
		<div class="wrap">
		...
		<script type="text/javascript" charset="utf-8">
			$.ajax({
				...
				dataType:"jsonp",
				data:{version:'<?php echo C("HDCMS_VERSION");?>'},
				crossDomain:true
			});
