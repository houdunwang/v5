...
<script type='text/javascript'>
		...
		URL = 'http://localhost/v5/cmsweb/hdcms/index.php?a=Admin';
		...
		CONTROL = 'http://localhost/v5/cmsweb/hdcms/index.php?a=Admin&c=Index';
		METH = 'http://localhost/v5/cmsweb/hdcms/index.php?a=Admin&c=Index&m=index';
		GROUP = 'http://localhost/v5/cmsweb/hdcms/hd';
		TPL = 'http://localhost/v5/cmsweb/hdcms/hd/Hdcms/Admin/Tpl';
		CONTROLTPL = 'http://localhost/v5/cmsweb/hdcms/hd/Hdcms/Admin/Tpl/Index';
		...
		CONTROLURL = 'http://localhost/v5/cmsweb/hdcms/index.php?a=Admin&c=Index';
</script>
		<script type="text/javascript" src="http://localhost/v5/cmsweb/hdcms/hd/Hdcms/Admin/Tpl/Index/js/menu.js"></script>
		<script type="text/javascript" src="http://localhost/v5/cmsweb/hdcms/hd/Hdcms/Admin/Tpl/Index/js/quick_menu.js"></script>
		<link type="text/css" rel="stylesheet" href="http://localhost/v5/cmsweb/hdcms/hd/Hdcms/Admin/Tpl/Index/css/css.css"/>
		<link type="text/css" rel="stylesheet" href="http://localhost/v5/cmsweb/hdcms/hd/Hdcms/Admin/Tpl/Index/css/quick_menu.css"/>
	</head>
	<body>
		<div class="nav">
			<!--头部左侧导航-->
...
echo "";
			...
			<div class="r_menu">
				...
				<span>|</span>
				<a href="http://localhost/v5/cmsweb/hdcms/index.php" target="_blank">
					前台首页
				</a>
				<span>|</span>
